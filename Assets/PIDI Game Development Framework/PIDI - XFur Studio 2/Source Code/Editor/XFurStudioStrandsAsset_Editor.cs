        ...
        public override void OnInspectorGUI() {
            ...
            if ( strandsAsset.xfurStrandsMethod == XFurStudioStrandsAsset.XFurStrandsMethod.ProcedurallyGenerated ) {
                ...
                if (BeginCenteredGroup("Procedural Generation Parameters", ref folds[0] ) ) {
                    ...
                    GUILayout.Box( "", pidiSkin2.customStyles[1], GUILayout.Height( 80 ), GUILayout.Width( 80 ) );
                    ...
                    GUILayout.BeginVertical();
                    GUILayout.Space( 8 );
                    strandsAsset.strandShapeA.horizontalSize = SliderField( new GUIContent( "Horizontal Size" ), strandsAsset.strandShapeA.horizontalSize );
                    strandsAsset.strandShapeA.verticalSize = SliderField( new GUIContent( "Vertical Size" ), strandsAsset.strandShapeA.verticalSize );
                    strandsAsset.strandShapeA.gradient = SliderField( new GUIContent( "Gradient" ), strandsAsset.strandShapeA.gradient );
                    ...
                    strandsAsset.firstPassDensity = SliderField( new GUIContent( "Strands Density" ), strandsAsset.firstPassDensity );
                    strandsAsset.firstPassSize = SliderField( new GUIContent( "Average Size" ), strandsAsset.firstPassSize );
                    strandsAsset.firstPassVariation = 1.0f - SliderField( new GUIContent( "Size Variation" ), 1.0f - strandsAsset.firstPassVariation, displayValue:false );
                    ...
                    GUILayout.BeginVertical();
                    GUILayout.Space( 8 );
                    strandsAsset.strandShapeB.horizontalSize = SliderField( new GUIContent( "Horizontal Size" ), strandsAsset.strandShapeB.horizontalSize );
                    strandsAsset.strandShapeB.verticalSize = SliderField( new GUIContent( "Vertical Size" ), strandsAsset.strandShapeB.verticalSize );
                    strandsAsset.strandShapeB.gradient = SliderField( new GUIContent( "Gradient" ), strandsAsset.strandShapeB.gradient );
                    GUILayout.EndVertical();
                    GUILayout.EndHorizontal();
                    GUILayout.FlexibleSpace();
                    GUILayout.EndVertical();
                    ...
                    strandsAsset.secondPassDensity = SliderField( new GUIContent( "Strands Density" ), strandsAsset.secondPassDensity );
                    strandsAsset.secondPassSize = SliderField( new GUIContent( "Average Size" ), strandsAsset.secondPassSize );
                    strandsAsset.secondPassVariation = 1.0f - SliderField( new GUIContent( "Size Variation" ), 1.0f - strandsAsset.secondPassVariation, displayValue: false );
