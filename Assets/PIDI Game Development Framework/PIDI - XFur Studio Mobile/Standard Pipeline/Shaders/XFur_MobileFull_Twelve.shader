...
Shader "PIDI Shaders Collection/XFur System/XFurMobile/Full/Twelve Samples" {
	Properties {
	...
	Fallback "PIDI Shaders Collection/XFur System/XFurMobile/Basic/Twelve Samples"
}
