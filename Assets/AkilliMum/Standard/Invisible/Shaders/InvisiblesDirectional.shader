Shader "AkilliMum/Standard/Invisible/InvisiblesDirectional" {
        ...
        SubShader{
            ...
            void surf(Input IN, inout SurfaceOutput o) {
                ...
                half3 lightDir = _WorldSpaceLightPos0.xyz; //it is just for directional light!
                if(dot(lightDir, o.Normal) < 0)  //that means normal of the pixel and the light are on same direction, so pixel does not see light :)
                    o.Alpha = 0;
            }
            ENDCG
        }
