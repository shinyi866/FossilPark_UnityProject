    ...
    public class XFurStudioPainterObject_Editor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (BeginCenteredGroup("XFur Painter Object", ref folds[0] ) ) {
                ...
                painterObject.PaintDataMode = (XFurStudioAPI.PaintDataMode)StandardEnumField( new GUIContent( "XFur Paint Mode" ), painterObject.PaintDataMode );
                ...
                if (painterObject.PainterObjectShape == XFurStudioPainterObject.PainterShape.Spherical ) {
                    painterObject.Radius = FloatField( new GUIContent( "Radius" ), painterObject.Radius );
                }
                else {
                    painterObject.BoxSize = Vector3Field( new GUIContent( "Size" ), painterObject.BoxSize );
                }
                ...
                if ( painterObject.PaintDataMode == XFurStudioAPI.PaintDataMode.SnowFX || painterObject.PaintDataMode == XFurStudioAPI.PaintDataMode.BloodFX || painterObject.PaintDataMode == XFurStudioAPI.PaintDataMode.WaterFX ) {
                    ...
                    painterObject.BrushOpacity = SliderField( new GUIContent( "Effect Intensity" ), painterObject.BrushOpacity, 0.0f, 10.0f );

                }
                else {

                    if ( painterObject.PaintDataMode == XFurStudioAPI.PaintDataMode.FurColor ) {
                        painterObject.BrushColor = ColorField( new GUIContent( "Brush Color" ), painterObject.BrushColor );
                    }

                    if ( painterObject.PaintDataMode != XFurStudioAPI.PaintDataMode.FurMask ) {                       
                        painterObject.BrushOpacity = SliderField( new GUIContent( "Effect Intensity" ), painterObject.BrushOpacity );
                        painterObject.BrushHardness = SliderField( new GUIContent( "Brush Hardness" ), painterObject.BrushHardness );
                    }
