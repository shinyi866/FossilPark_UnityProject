...
namespace XFurStudio2 {
    ...
    public class XFurStudioDatabase : ScriptableObject {
        ...
        private string databaseVersion = "v2.1.0";
        ...
        [SerializeField] protected Shader XFShells, Basic8, Basic4, XFURP, XFHDRP;
        ...
        [SerializeField] protected Material HDRPShells, HDRPShellsDouble;
        ...
        public void LoadResources() {
            ...
            if( !HDRPShellsDouble ) {
                if ( XFHDRP ) {
                    ...
                    HDRPShellsDouble.shader = Shader.Find( "Hidden/XFur Studio 2/HDRP ShellsD" );
                }
            }
            else {
                HDRPShellsDouble.enableInstancing = true;
