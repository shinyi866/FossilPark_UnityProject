...
namespace XFurStudio2 {
    ...
    public class XFurStudioWindZone_Editor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayout.Space( 16 );
            CenteredLabel( "XFur Studio™ 2 - Wind & Weather Manager, v" + windZone.Version );
            GUILayout.Space( 16 );

            if (BeginCenteredGroup("Wind Simulation", ref folds[0] ) ) {
                GUILayout.Space( 16 );
                windZone.WindStrength = SliderField( new GUIContent( "Wind Strength" ), windZone.WindStrength, 0 , 2 );
                windZone.WindFrequency = SliderField( new GUIContent( "Wind Frequency" ), windZone.WindFrequency, 0 , 32 );
                GUILayout.Space( 16 );
            }
            EndCenteredGroup();
            ...
            if (BeginCenteredGroup("Snow Simulation", ref folds[1] ) ) {
                GUILayout.Space( 16 );
                windZone.SnowIntensity = SliderField( new GUIContent( "Snow Intensity" ), windZone.SnowIntensity );
                windZone.SnowAbsDirection = Vector3Field( new GUIContent( "Snow Direction" ), windZone.SnowAbsDirection );
                windZone.SnowWindInfluence = SliderField( new GUIContent( "Wind Influence over Snow" ), windZone.SnowWindInfluence, 0 , 2 );
                GUILayout.Space( 16 );
            }
            EndCenteredGroup();
            ...
            if (BeginCenteredGroup("Rain Simulation", ref folds[2] ) ) {
                GUILayout.Space( 16 );
                windZone.RainIntensity = SliderField( new GUIContent( "Rain Intensity" ), windZone.RainIntensity );
                windZone.RainAbsDirection = Vector3Field( new GUIContent( "Rain Direction" ), windZone.RainAbsDirection );
                windZone.RainWindInfluence = SliderField( new GUIContent( "Wind Influence over Rain" ), windZone.RainWindInfluence, 0 , 2 );
                GUILayout.Space( 16 );
            }
            EndCenteredGroup();
